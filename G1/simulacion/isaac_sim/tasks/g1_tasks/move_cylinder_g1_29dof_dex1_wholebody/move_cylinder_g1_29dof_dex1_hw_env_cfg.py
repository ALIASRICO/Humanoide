...
class ObjectTableSceneCfg(TableCylinderSceneCfgWH):
    ...
    # contact_forces disabled for visual inspection (OOM with 32GB VRAM)
    ...
    # robot_camera disabled for visual inspection (5th camera causes OOM)
...
class MoveCylinderG129Dex1WholebodyEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        # simulation settings
        self.sim.dt = 0.005
        # self.scene.contact_forces.update_period = self.sim.dt  # disabled: contact_forces commented out
